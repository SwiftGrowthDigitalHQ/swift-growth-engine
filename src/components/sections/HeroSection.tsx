      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center animate-slide-up">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-display font-bold leading-tight mb-6 text-foreground">
            ...
            <br />
            <span className="bg-gradient-orange bg-clip-text text-transparent">We Build Complete</span>
            <br />
            <span className="bg-gradient-orange bg-clip-text text-transparent">Growth Systems.</span>
          </h1>
