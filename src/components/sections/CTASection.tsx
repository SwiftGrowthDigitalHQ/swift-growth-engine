    ...
    <section className="py-20 md:py-28 relative overflow-hidden bg-primary/5">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-whatsapp/10 border border-whatsapp/20 mb-8">
            <Gift className="w-4 h-4 text-whatsapp" />
            <span className="text-sm font-medium text-whatsapp">Limited Time Offer</span>
          </div>
          
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold mb-6 text-foreground">
            Get Your <span className="bg-gradient-sky bg-clip-text text-transparent">FREE Growth Audit</span>
            <br />
            Worth ₹2,999
          </h2>
